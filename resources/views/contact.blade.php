...
<section class="faq-section">
    ...
    <div class="faq-grid">
        <div class="faq-item">
            <h3><i class="fas fa-truck"></i> Livraison et délais</h3>
            <p>Nous livrons sous 24h à Casablanca et 48-72h dans les autres villes du Maroc. Les commandes passées avant 14h sont expédiées le jour même.</p>
        </div>
        
        <div class="faq-item">
            <h3><i class="fas fa-exchange-alt"></i> Retours et échanges</h3>
            <p>Vous avez 14 jours pour retourner un produit non utilisé, dans son emballage d'origine. Les frais de retour sont à votre charge.</p>
        </div>
        
        <div class="faq-item">
            <h3><i class="fas fa-shield-alt"></i> Garantie produits</h3>
            <p>Tous nos produits bénéficient d'une garantie constructeur de 2 ans. En cas de défaut de fabrication, nous prenons en charge la réparation ou l'échange.</p>
        </div>
        
        <div class="faq-item">
            <h3><i class="fas fa-credit-card"></i> Paiement sécurisé</h3>
            <p>Nous acceptons les cartes bancaires (Visa, Mastercard), les virements bancaires et le paiement à la livraison dans certaines villes.</p>
        </div>
    </div>
</section>

<section class="map-section">
    <h2 style="font-size: 28px; margin-bottom: 20px; color: #0F172A;">Notre localisation</h2>
    <div class="map-container">
        <div class="map-placeholder">
            <div style="text-align: center;">
                <i class="fas fa-map-marked-alt" style="font-size: 48px; margin-bottom: 20px;"></i>
                <p>123 Avenue Mabrouk,Tanger</p>
                <p style="font-size: 14px; opacity: 0.8;">Carte interactive disponible prochainement</p>
            </div>
        </div>
    </div>
</section>
